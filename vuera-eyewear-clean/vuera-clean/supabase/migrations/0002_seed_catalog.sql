...
Populates the catalog taxonomy and inserts 8 sample products with images,
variants, and category associations. Idempotent via ON CONFLICT.

## What's inserted
- 2 brands (Vuera Studio, North Optics)
- 4 categories (optical, sunglasses, blue-light, readers)
- 9 colors (tortoise, matte black, crystal, gold, silver, champagne, onyx, rose, gunmetal)
- 7 frame shapes (round, square, rectangular, oval, cat-eye, aviator, geometric)
- 4 materials (acetate, metal, titanium, mixed)
- 8 sizes (48, 50, 52, 53, 54, 55, 58, 60 mm)
- 8 sample products, each with 3 images and 2-3 variants

## Notes
- All prices are integer cents (e.g. 18900 = $189.00).
- Images use Pexels URLs.
- Products are linked to categories via product_categories join table.
*/
...
INSERT INTO public.colors (name, slug, hex_code) VALUES
  ('Tortoise', 'tortoise', '#8B5A2B'), ('Matte Black', 'matte-black', '#1A1A1A'),
  ('Crystal', 'crystal', '#E8E8E8'), ('Gold', 'gold', '#D4AF37'),
  ('Silver', 'silver', '#C0C0C0'), ('Champagne', 'champagne', '#F7E7CE'),
  ('Onyx', 'onyx', '#0A0A0A'), ('Rose', 'rose', '#E8B4B8'), ('Gunmetal', 'gunmetal', '#4A4A4A')
ON CONFLICT (slug) DO NOTHING;

INSERT INTO public.frame_shapes (slug, name) VALUES
  ('round', 'Round'), ('square', 'Square'), ('rectangular', 'Rectangular'),
  ('oval', 'Oval'), ('cat-eye', 'Cat-eye'), ('aviator', 'Aviator'), ('geometric', 'Geometric')
ON CONFLICT (slug) DO NOTHING;

INSERT INTO public.materials (slug, name) VALUES
  ('acetate', 'Acetate'), ('metal', 'Metal'), ('titanium', 'Titanium'), ('mixed', 'Mixed')
ON CONFLICT (slug) DO NOTHING;

INSERT INTO public.sizes (size_mm, label) VALUES
  (48, '48mm'), (50, '50mm'), (52, '52mm'), (53, '53mm'),
  (54, '54mm'), (55, '55mm'), (58, '58mm'), (60, '60mm')
...
DECLARE
  ...
  v_p_aurora uuid; v_p_meridian uuid; v_p_atlas uuid; v_p_nova uuid;
  v_p_horizon uuid; v_p_lumina uuid; v_p_orbit uuid; v_p_eclipse uuid;
BEGIN
  ...
  VALUES ('aurora-cat-eye', 'Aurora', v_brand_vuera, 'A sculpted cat-eye frame with a subtle upswept brow line. Hand-polished Italian acetate with stainless steel hinges.', v_shape_cat, v_mat_acetate, 'women', 'single-vision', 18900, NULL, 'active', 4.8, 124)
  ON CONFLICT (slug) DO NOTHING RETURNING id INTO v_p_aurora;
  ...
  INSERT INTO public.product_categories (product_id, category_id) VALUES (v_p_aurora, v_cat_optical), (v_p_aurora, v_cat_sunglasses) ON CONFLICT DO NOTHING;

  INSERT INTO public.products (slug, name, brand_id, description, shape_id, material_id, gender, lens_type, price_cents, compare_at_price_cents, status, rating, review_count)
  VALUES ('meridian-aviator', 'Meridian', v_brand_vuera, 'A modern take on the classic aviator. Lightweight titanium frame with gradient polarized lenses.', v_shape_avi, v_mat_metal, 'unisex', 'sunglasses', 21900, NULL, 'active', 4.6, 89)
  ON CONFLICT (slug) DO NOTHING RETURNING id INTO v_p_meridian;
  INSERT INTO public.product_images (product_id, url, alt_text, position, is_ai_generated) VALUES
  ...
  ON CONFLICT (sku) DO NOTHING;
  INSERT INTO public.product_categories (product_id, category_id) VALUES (v_p_meridian, v_cat_sunglasses) ON CONFLICT DO NOTHING;

  INSERT INTO public.products (slug, name, brand_id, description, shape_id, material_id, gender, lens_type, price_cents, compare_at_price_cents, status, rating, review_count)
  VALUES ('atlas-round', 'Atlas', v_brand_north, 'Perfectly round lenses in a chunky acetate frame. A statement piece inspired by 1960s intellectuals.', v_shape_round, v_mat_acetate, 'unisex', 'single-vision', 12900, 15900, 'active', 4.4, 67)
  ON CONFLICT (slug) DO NOTHING RETURNING id INTO v_p_atlas;
  INSERT INTO public.product_images (product_id, url, alt_text, position, is_ai_generated) VALUES
  ...
  ON CONFLICT (sku) DO NOTHING;
  INSERT INTO public.product_categories (product_id, category_id) VALUES (v_p_atlas, v_cat_optical), (v_p_atlas, v_cat_bluelight) ON CONFLICT DO NOTHING;

  INSERT INTO public.products (slug, name, brand_id, description, shape_id, material_id, gender, lens_type, price_cents, compare_at_price_cents, status, rating, review_count)
  VALUES ('nova-geometric', 'Nova', v_brand_vuera, 'Bold geometric silhouette with sharp angular lines. For those who refuse to blend in.', v_shape_geo, v_mat_acetate, 'women', 'single-vision', 20900, NULL, 'active', 4.9, 156)
  ON CONFLICT (slug) DO NOTHING RETURNING id INTO v_p_nova;
  INSERT INTO public.product_images (product_id, url, alt_text, position, is_ai_generated) VALUES
  ...
  ON CONFLICT (sku) DO NOTHING;
  INSERT INTO public.product_categories (product_id, category_id) VALUES (v_p_nova, v_cat_optical), (v_p_nova, v_cat_sunglasses) ON CONFLICT DO NOTHING;

  INSERT INTO public.products (slug, name, brand_id, description, shape_id, material_id, gender, lens_type, price_cents, compare_at_price_cents, status, rating, review_count)
  VALUES ('horizon-square', 'Horizon', v_brand_north, 'Architectural square frame in featherlight titanium. Clean lines for a confident, modern look.', v_shape_sq, v_mat_titanium, 'men', 'single-vision', 17900, NULL, 'active', 4.5, 92)
  ON CONFLICT (slug) DO NOTHING RETURNING id INTO v_p_horizon;
  INSERT INTO public.product_images (product_id, url, alt_text, position, is_ai_generated) VALUES
  ...
  ON CONFLICT (sku) DO NOTHING;
  INSERT INTO public.product_categories (product_id, category_id) VALUES (v_p_horizon, v_cat_optical), (v_p_horizon, v_cat_bluelight) ON CONFLICT DO NOTHING;

  INSERT INTO public.products (slug, name, brand_id, description, shape_id, material_id, gender, lens_type, price_cents, compare_at_price_cents, status, rating, review_count)
  VALUES ('lumina-oval', 'Lumina', v_brand_vuera, 'Soft oval frame with a gentle keyhole bridge. Universally flattering and impossibly light.', v_shape_oval, v_mat_acetate, 'women', 'single-vision', 13900, 16900, 'active', 4.7, 108)
  ON CONFLICT (slug) DO NOTHING RETURNING id INTO v_p_lumina;
  INSERT INTO public.product_images (product_id, url, alt_text, position, is_ai_generated) VALUES
  ...
  ON CONFLICT (sku) DO NOTHING;
  INSERT INTO public.product_categories (product_id, category_id) VALUES (v_p_lumina, v_cat_optical), (v_p_lumina, v_cat_readers) ON CONFLICT DO NOTHING;

  INSERT INTO public.products (slug, name, brand_id, description, shape_id, material_id, gender, lens_type, price_cents, compare_at_price_cents, status, rating, review_count)
  VALUES ('orbit-rectangular', 'Orbit', v_brand_north, 'Slim rectangular frame with a brushed metal finish. Understated and endlessly versatile.', v_shape_rect, v_mat_metal, 'men', 'single-vision', 14900, NULL, 'active', 4.3, 54)
  ON CONFLICT (slug) DO NOTHING RETURNING id INTO v_p_orbit;
  INSERT INTO public.product_images (product_id, url, alt_text, position, is_ai_generated) VALUES
  ...
  ON CONFLICT (sku) DO NOTHING;
  INSERT INTO public.product_categories (product_id, category_id) VALUES (v_p_orbit, v_cat_optical), (v_p_orbit, v_cat_bluelight) ON CONFLICT DO NOTHING;

  INSERT INTO public.products (slug, name, brand_id, description, shape_id, material_id, gender, lens_type, price_cents, compare_at_price_cents, status, rating, review_count)
  VALUES ('eclipse-aviator', 'Eclipse', v_brand_vuera, 'Oversized aviator with a double bridge and mirrored lenses. Maximum coverage, maximum impact.', v_shape_avi, v_mat_metal, 'unisex', 'sunglasses', 23900, NULL, 'active', 4.8, 73)
  ON CONFLICT (slug) DO NOTHING RETURNING id INTO v_p_eclipse;
  INSERT INTO public.product_images (product_id, url, alt_text, position, is_ai_generated) VALUES
  ...
  ON CONFLICT (sku) DO NOTHING;
  INSERT INTO public.product_categories (product_id, category_id) VALUES (v_p_eclipse, v_cat_sunglasses) ON CONFLICT DO NOTHING;
END $$;